...
# This part is image labels setting start 
        ...
        # title-section
        title_lb1 = Label(bg_img,text="Student Facial Recognition Attendance Management System",font=("Times New Roman",15,"bold"),bg="white",fg="navyblue")
        ...
        std_b1_1 = Button(bg_img,command=self.student_pannels,text="Enrol New Student",cursor="hand2",font=("Times New Roman",15,"bold"),bg="white",fg="navyblue")
        ...
        det_b1_1.place(x=481,y=281,width=181,height=46)
