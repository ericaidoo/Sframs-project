...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        #title-section
        title_lb1 = Label(bg_img,text="Welcome to Facial Recognition",font=("verdana",30,"bold"),bg="white",fg="navyblue")
    ...
    def mark_attendance(self,i,r,n):
        ...
        with open("attendance.csv","r+",newline="\n") as f:
            ...
            # check if the user does not exist in the list then mark him/her as attented
            if((i not in temp_list)) and ((r not in temp_list)) and ((n not in temp_list)):
                now=datetime.now()
    ...
    def face_recog(self):
        ...
        # face recognizer when live video running
